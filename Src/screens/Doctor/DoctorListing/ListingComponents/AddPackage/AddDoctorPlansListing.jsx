import { View, Text, ScrollView, SafeAreaView, Alert, Modal } from 'react-native';
                ...
                <View key={plan.doctor_fee_plan_id} style={{ marginBottom: 25 }}>
                  <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                    ...
                    <View style={{ flexDirection: 'row', gap: 10 }}>
                      <MaterialCommunityIcons name="pencil" color="#E72B4A" size={hp(2.5)} />
                      <MaterialCommunityIcons name="delete" color="#E72B4A" size={hp(2.5)} />
                    </View>
                  </View>
                  <View
                    style={{
